...
точные команды и патчи Main либо пишет элементарный код по конкретному образцу
из проекта или от Main. Сложная логика остаётся у Main. При проблеме Main
выбирает короткое точное исправление или готовый патч для нужного участка.
