...
Все hooks Scope Focus после установки отключены; владелец включает нужные hooks
вручную.
...
Scope Focus запиши `enabled = false` по его точному ключу. Старый хеш или обход
...
Через app-server
согласуй trust изменённых hook-определений и отключи каждый hook обновлённого
