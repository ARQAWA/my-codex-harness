...
description: Read before planning or doing work under Scope Focus, especially when the user says our work standards or principles; contains the complete general working rules.
---

# Working Standards

Read these standards before planning or acting on the selected task. Revisit
them when the task materially changes or context is lost.
